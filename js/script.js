...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (hamburger && navLinks) hamburger.addEventListener('click', toggleMenu, { passive: true });
  if (navBackdrop) navBackdrop.addEventListener('click', closeMenu, { passive: true });
